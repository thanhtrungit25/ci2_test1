...
class Users extends CI_Controller
{
	...
	public function edit_user()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$data['first_name'] = array('name' => 'first_name', 'id' => 'first_name', 'value' => set_value('first_name', $first_name), 'max_length' => '100', 'size' => '35');
			$data['last_name'] = array('name' => 'last_name', 'id' => 'last_name', 'value' => set_value('last_name', $last_name), 'max_length' => '100', 'size' => '35');
			$data['email'] = array('name' => 'email', 'id' => 'email', 'value' => set_value('email', $email), 'max_length' => '100', 'size' => '35');
			$data['is_active'] = array('name' => 'is_active', 'id' => 'is_active', 'value' => set_value('is_active', $is_active));
			$data['id'] = array('id' => set_value('id', $id));

			$this->load->view('users/edit_user', $data);
		} else { // Validation pass, now escape the data
			$data = array(
	...
	public function new_user()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			// First load, or problem with form
			$data['first_name'] = array('name' => 'first_name', 'id' => 'first_name', 'value' => set_value('first_name', ''), 'max_length' => '100', 'size' => '35');
			$data['last_name'] = array('name' => 'last_name', 'id' => 'last_name', 'value' => set_value('last_name', ''), 'max_length' => '100', 'size' => '35');
			$data['email'] = array('name' => 'email', 'id' => 'email', 'value' => set_value('email', ''), 'max_length' => '100', 'size' => '35');
	...
	public function delete_user()
	{
		...
		$this->form_validation->set_rules('id', 'User ID', 'required|min_length[1]|max_length[1]|integer|is_natural');
